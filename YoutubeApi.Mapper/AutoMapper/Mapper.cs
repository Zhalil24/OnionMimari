...
namespace YoutubeApi.Mapper.AutoMapper
{
    ...
    {   
        ...
        public IList<TDestination> Map<TDestination, TSoruce>(IList<TSoruce> source, string? ignore = null)
        {
            Config<TDestination, TSoruce>(5, ignore);

            return MapperContainer.Map<IList<TSoruce>, IList<TDestination>>(source);
        }
